...
@Component({
  selector: 'app-academy-contributors',
  templateUrl: './academy-contributors.component.html',
  styleUrls: ['./academy-contributors.component.scss']
})
export class AcademyContributorsComponent implements OnInit {
